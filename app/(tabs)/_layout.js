...
export default function TabLayout() {
  ...
  const handleAddPress = () => {
    ...
    setTimeout(() => {
      if (["driver", "delivery_company", "admin", "manager", "entery", "warehouse_admin", "warehouse_staff", "business"].includes(user.role)) {
  ...
  const tabs = [
    ...
    },
    {
      ...
      options: {
        ...
        tabBarIcon: ({focused}) => createTabBarIcon(AntDesign, "holder", focused),
      },
    },
  ];
