...
export const translations = {
  en: {
    ...
    common: {
      ...
      selectAllUnpaid: "Select All false financial_status",
      select: "Select"
    },
    ...
    tabs: {
      ...
      orders: {
        ...
        filters: {
          ...
          to_branch: "To Branch",
          previous_branches: "Previous Branches",
          last_status_updated_by: "Last Status Updated By",
          last_status_updated_at_day: "Last Status Updated At Day",
          last_status_updated_at_week: "Last Status Updated At Week",
          last_status_updated_at_month: "Last Status Updated At Month",
          last_status_updated_at_quarter: "Last Status Updated At Quarter",
          last_status_updated_at_year: "Last Status Updated At Year",
          delivered_at_day: "Delivered At Day",
          delivered_at_week: "Delivered At Week",
          delivered_at_month: "Delivered At Month",
          delivered_at_quarter: "Delivered At Quarter",
          delivered_at_year: "Delivered At Year",
          created_at_day: "Created At Day",
          created_at_week: "Created At Week",
          created_at_month: "Created At Month",
          created_at_quarter: "Created At Quarter",
          created_at_year: "Created At Year"
        },
        track: {
          ...
          contactTrailsSummary: "Driver contact attempts",
          contactTrailsCallTry: "Driver tried to call your customer {count} times",
          contactTrailsWhatsappTry: "Driver tried to WhatsApp your customer {count} times",
          contactTrailsSmsTry: "Driver tried to message your customer {count} times",
          calls: "Calls",
          messages: "Messages",
          noHistory: "No history",
          addPrivateNote: "Add Private Note",
          yourNote: "Your Note",
          privateNotePlaceholder: "Write your private note",
          privateNoteValidation: "Please enter a note",
          privateNoteFailed: "Failed to add private note",
          noteSuccess: "Private note added",
        ...
        "order": {
          ...
          "packageItemsTitle": "Package items",
          "packageItemsShow": "Show",
          "packageItemsHide": "Hide",
          "followUpAlertTitle": "Main order with follow-up packages",
          "followUpAlertMessage": "This order is the main package and has follow-up packages linked to it. Updating its status may affect all related packages. Please proceed carefully.",
          "print": "Print",
          "location": "Location",
          ...
          sections: {
            ...
            client: {
              ...
              fields: {
                ...
                enter_more: "Enter at least 3 characters to search",
    ...
    collections: {
      ...
      collection: {
        ...
        proofCamera: {
          ...
          scanHint: "Scan the QR/Barcode on the collection paper",
          matched: "Matched",
          mismatch: "Scanned ID {scannedId} does not match Collection #{collectionId}",
          scanFirst: "Scan the collection QR/Barcode first",
          wrongCollectionForThis: "Wrong collection QR/Barcode for this collection",
    ...
    action: {
      options: {
        moneyRecord: "Money Record",
        returnedRecord: "Returned Record",
        returnedRecordCollections: "Returned Collection",
        businessRecordTitle: "Create Business Collection",
        returnedRecordTitle: "Create Returned Collection",
        fromDriverBalance: "Create from Driver Balance?",
        yesFromDriverBalance: "Create from Driver Balance",
        noFromDriverBalance: "Exclude Driver Balance",
        businessMoneyConfirmTitle: "Create Money Record?",
        businessMoneyConfirmText: "Are you sure you want to create a money record?",
        businessReturnedConfirmTitle: "Create Returned Record?",
        businessReturnedConfirmText: "Are you sure you want to create a returned record?",
        createWithoutSender: "Exclude Senders",
        assign: "Assign",
        assignCompany: "Assign Company",
        selectCompanyToAssign: "Select a company to assign orders to",
        removeDriver: "Remove Driver",
        updateNote: "Update Order Note",
        updateNoteForMultiple: "Update Note for Multiple Orders"
      }
    },

    collectionBranchSection: {
      rows: {
        current_branch: "Current Branch"
      }
    },
    ...
    withdrawalsOptions: {
      driver_salaries: "Driver Salaries",
      fuel: "Fuel",
      utilities_purchase: "Utilities Purchase",
      advance: "Advance",
    ...
    financialPreview: {
      ...
      loading: "Loading financial information...",
      error: "An error occurred",
      totalCodValue: "Total COD Value",
      totalExpenses: "Total Expenses",
      finalAmount: "Final Amount",
      totalSummary: "Total Summary",
      driverInfo: "Driver Info",
      totalOrders: "Total Orders",
      driverOutsourceFee: "Driver Outsource Fee",
      noFinancialData: "No Financial Data",
      driverInfoValue: "Driver: {driver_name}"
    },
  ...
  ar: {
    ...
    common: {
      ...
      selectAllUnpaid: "تحديد غير المدفوع",
      select: "تحديد",
      note: "ترك ملاحظة (اختياري)",
      open: "مشاهدة جميع الطرود",
      noResults: "لا توجد نتائج"
    },
    ...
    chat: {
      ...
      startBusinessConversation: "بدء محادثة مع التاجر",
      supportChat: "الدعم",
    },
    ...
    errors: {
      ...
      requestTimedOut: "يرجى التحقق من اتصالك بالانترنت والمحاولة مرة أخرى.",
      ...
      networkRequestFailed: "فشل الاتصال بالشبكة. يرجى التحقق من اتصال الإنترنت والمحاولة مرة أخرى.",
    ...
    tabs: {
      ...
      orders: {
        ...
        filters: {
          ...
          to_branch: "إلى الفرع",
          previous_branches: "الفروع السابقة",
          last_status_updated_by: "آخر تحديث للحالة بواسطة",
          last_status_updated_at_day: "آخر تحديث للحالة - يوم",
          last_status_updated_at_week: "آخر تحديث للحالة - أسبوع",
          last_status_updated_at_month: "آخر تحديث للحالة - شهر",
          last_status_updated_at_quarter: "آخر تحديث للحالة - ربع سنة",
          last_status_updated_at_year: "آخر تحديث للحالة - سنة",
          delivered_at_day: "تم التوصيل - يوم",
          delivered_at_week: "تم التوصيل - أسبوع",
          delivered_at_month: "تم التوصيل - شهر",
          delivered_at_quarter: "تم التوصيل - ربع سنة",
          delivered_at_year: "تم التوصيل - سنة",
          created_at_day: "تاريخ الإنشاء - يوم",
          created_at_week: "تاريخ الإنشاء - أسبوع",
          created_at_month: "تاريخ الإنشاء - شهر",
          created_at_quarter: "تاريخ الإنشاء - ربع سنة",
          created_at_year: "تاريخ الإنشاء - سنة"
        },
        track: {
          ...
          "orderRecord": "سجل الطرد",
          "view": "عرض",
          "contactTrails": "سجل التواصل",
          "contactTrailsSummary": "محاولات تواصل السائق",
          "contactTrailsCallTry": "حاول السائق الاتصال بالزبون {count} مرات",
          "contactTrailsWhatsappTry": "حاول السائق مراسلة الزبون عبر واتساب {count} مرات",
          "contactTrailsSmsTry": "حاول السائق مراسلة الزبون {count} مرات",
          "calls": "المكالمات",
          "messages": "الرسائل",
          "noHistory": "لا يوجد سجل",
          "addPrivateNote": "إضافة ملاحظة خاصة",
          "yourNote": "ملاحظتك",
          "privateNotePlaceholder": "اكتب ملاحظتك الخاصة",
          "privateNoteValidation": "يرجى إدخال ملاحظة",
          "privateNoteFailed": "فشل إضافة الملاحظة الخاصة",
          "noteSuccess": "تمت إضافة الملاحظة الخاصة",
        ...
        "order": {
          ...
          "packageItemsTitle": "التوابع",
          "packageItemsShow": "عرض",
          "packageItemsHide": "إخفاء",
          "followUpAlertTitle": "طرد يحتوي توابع",
          "followUpAlertMessage": "يوجد توابع لهذا الطرد. يرجى الانتباه.",
          "print": "طباعة",
          "location": "الموقع",
          ...
          sections: {
            ...
            sender: {
              ...
              fields: {
                ...
                "auto_deduction_message": "طرد احضار سوف يتم الخصم تلقائيا من رصيدك عند التأكيد, في حال لم يكن لديك رصيد كافي الرجاء التوجه الى اقرب فرع لدفع قيمة هذه العملية لدى موظف الاستقبال.",
                "auto_deduction_message_payment": "طرد دفع سوف يتم الخصم تلقائيا من رصيدك عند التأكيد, في حال لم يكن لديك رصيد كافي الرجاء التوجه الى اقرب فرع لدفع قيمة هذه العملية لدى موظف الاستقبال."
              }
            },
            client: {
              title: "الزبون",
              fields: {
                ...
                found: "تم ايجاد",
                receivers: "زبائن",
                search_error: "فشل البحث، حاول مرة أخرى",
                no_results: "لا يوجد زبائن",
                enter_more: "ادخل 3 أحرف على الأقل للبحث",
                add_new: "اضافة زبون جديد",
                enter_valid_phone: "ادخل رقم هاتف صالح مكون من 10 ارقام",
                add_new_receiver: "اضافة زبون جديد",
                unnamed: "غير معروف",
                search_receiver: "ابحث عن الزبون",
                search_placeholder: "ادخل الاسم أو رقم الهاتف"
              }
            },
            cost: {
              title: "التكلفة",
            ...
            details: {
              ...
              fields: {
                ...
                orderType: "نوع الطرد",
                packageItems: "التوابع",
                addPackageItem: "اضافة تابع",
                emptyPackageItems: "لا يوجد توابع",
                packageQrPlaceholder: "رقم QR للتابع"
              }
            },
            orderTypes: {
              title: "نوع الطرد",
      ...
      createMultiple: {
        title: "إنشاء سريع",
        description: "اكتب او الصق نصا يحتوي على المعلومات الخاصة بطردك او عدة طرود ثم اضفط تحليل النص",
        analyze: "تحليل النص",
        submit: "إرسال",
        summary: "الملخص",
        loading: "جاري التحميل...",
    ...
    collections: {
      ...
      collection: {
        handed_over: "تأكيد التسليم",
        submit_proof: "التسليم إثبات",
        proofCamera: {
          permissionRequired: "مطلوب إذن الكاميرا",
          scanHint: "امسح رمز QR/Barcode الموجود على ورقة التجميعة",
          matched: "تم التطابق",
          mismatch: "المعرف الممسوح {scannedId} لا يطابق الكشف رقم {collectionId}",
          scanFirst: "قم أولاً بمسح QR/Barcode الخاص بالتجميعة",
          wrongCollectionForThis: "QR/Barcode لا يخص هذه التجميعة",
        ...
        dispatch_to_sender: "ارسال الى المرسل",
    ...
    users: {
      ...
      user: {
        ...
        totalOrders: "عدد الطرود الكلي",
        successOrders: "عدد الطرود المكتملة",
        failedOrders: "عدد الطرود المرتجعة",
        noOrdersFound: "لا توجد طرود"
      },
      // (create_user)
      create: {
        edit: "تعديل المستخدم",
    ...
    routesTitle: "إدارة المسارات",
    createOrdersTitle: "إنشاء طلبات",
    createOrdersMessage: "أنشئ طلبات جديدة بسرعة وكفاءة.",
    routesMessage: "إنشاء وإدارة مسارات التوصيل لتحسين عمليات التوصيل. قم بتخطيط رحلتك وتتبع التقدم كلما أنجزت طلبات.",

    action: {
      options: {
        moneyRecord: "محاسبة السائق",
        businessRecordCollections: "كشف تحصيل تاجر",
        returnedRecord: "جرد الطرود",
        returnedRecordCollections: "كشف مرتجعات للتاجر",
        businessRecordTitle: "انشاء تحصيل مالي",
        returnedRecordTitle: "جرد الطرود",
        fromDriverBalance: "إنشاء من رصيد السائق؟",
        yesFromDriverBalance: "من رصيد السائق",
        noFromDriverBalance: "ليس من رصيد السائق",
        businessMoneyConfirmTitle: "إنشاء سجل مالي؟",
        businessMoneyConfirmText: "هل أنت متأكد أنك تريد إنشاء سجل مالي؟",
        businessReturnedConfirmTitle: "جرد الطرود",
        businessReturnedConfirmText: "هل أنت متأكد أنك تريد جرد الطرود المحددة؟",
        createWithoutSender: "استبعاد المرسلين",
        assign: "تعيين",
        assignCompany: "تعيين شركة",
        selectCompanyToAssign: "اختر شركة لتعيين الطلبات إليها",
        removeDriver: "إزالة السائق",
        updateNote: "تحديث ملاحظة الطلب",
        updateNoteForMultiple: "تحديث الملاحظة لعدة طلبات"
      }
    },
    ...
    withdrawalsOptions: {
      driver_salaries: "عمولة السائق",
      fuel: "وقود",
      utilities_purchase: "شراء مستلزمات مكتبية",
      advance: "سلفة",
      maintenance: "صيانة",
      bills: "فواتير",
      oversize: "تحجيم",
      collection_payment: "دفع تحصيل",
      other: "أخرى"
    },
    receivedAmounts: {
    ...
    financialPreview: {
      title: "الملخص المالي",
      loading: "جاري تحميل المعلومات المالية...",
      error: "حدث خطأ ما",
      totalCodValue: "إجمالي قيمة الطرود",
      totalExpenses: "إجمالي المصاريف",
      finalAmount: "المبلغ النهائي",
      totalSummary: "الملخص الإجمالي",
      driverInfo: "معلومات السائق",
      totalOrders: "إجمالي الطلبات",
      driverOutsourceFee: "رسوم التوصيل للسائق",
      noFinancialData: "لا توجد بيانات مالية",
      driverInfoValue: "السائق:",
      orders: "الطلبات",
      driverFee: "رسوم التوصيل للسائق"
    },
  ...
  he: {
    ...
    "errors": {
      ...
      "networkRequestFailed": "בקשת רשת נכשלה. אנא בדוק את חיבור האינטרנט ונסה שוב.",
    ...
    "tabs": {
      ...
      "orders": {
        ...
        "track": {
          ...
          "orderRecord": "רישום הזמנה",
          "view": "צפה",
          "contactTrails": "תיעוד תקשורת",
          "contactTrailsSummary": "ניסיונות יצירת קשר של הנהג",
          "contactTrailsCallTry": "הנהג ניסה להתקשר ללקוח {count} פעמים",
          "contactTrailsWhatsappTry": "הנהג ניסה לשלוח וואטסאפ ללקוח {count} פעמים",
          "contactTrailsSmsTry": "הנהג ניסה לשלוח הודעה ללקוח {count} פעמים",
          "calls": "שיחות",
          "messages": "הודעות",
          "noHistory": "אין היסטוריה",
          "addPrivateNote": "הוסף הערה פרטית",
          "yourNote": "ההערה שלך",
          "privateNotePlaceholder": "כתוב הערה פרטית",
          "privateNoteValidation": "אנא הזן הערה",
          "privateNoteFailed": "נכשל להוסיף הערה פרטית",
          "noteSuccess": "הערה פרטית נוספה",
        ...
        "order": {
          ...
          "packageItemsTitle": "חבילות משנה",
          "packageItemsShow": "הצג",
          "packageItemsHide": "הסתר",
          "followUpAlertTitle": "הזמנה ראשית עם חבילות משנה",
          "followUpAlertMessage": "הזמנה זו היא חבילה ראשית ויש לה חבילות משנה מקושרות. שינוי הסטטוס עשוי להשפיע על כל החבילות הקשורות. אנא המשך בזהירות.",
          "print": "הדפס",
          "location": "מיקום",
          ...
          "sections": {
            ...
            "client": {
              ...
              "fields": {
                ...
                "found": "נמצא",
                "receivers": "לקוחות",
                "search_error": "החיפוש נכשל, נסה שוב",
                "no_results": "אין לקוחות",
                "enter_more": "הזן לפחות 3 תווים לחיפוש",
                "add_new": "הוסף לקוח חדש",
                "enter_valid_phone": "הזן מספר טלפון תקף",
                "add_new_receiver": "הוסף לקוח חדש",
                "unnamed": "לא ידוע",
                "search_receiver": "חפש לקוח",
                "search_placeholder": "הזן שם או מספר טלפון"
              }
            },
            "cost": {
              "title": "עלות",
    ...
    "collections": {
      ...
      "collection": {
        ...
        "handed_over": "אישור משלוח",
        "submit_proof": "להגיש הוכחה",
        "proofCamera": {
          "permissionRequired": "נדרשת הרשאת מצלמה",
          "scanHint": "סרוק את ה‑QR/Barcode שעל דף האוסף",
          "matched": "התאמה בוצעה",
          "mismatch": "המזהה שנסרק {scannedId} אינו תואם לאוסף מספר {collectionId}",
          "scanFirst": "תחילה יש לסרוק QR/Barcode של האוסף",
          "wrongCollectionForThis": "ה‑QR/Barcode לא שייך לאוסף הזה",
          "captureFailed": "צילום התמונה נכשל"
        },
    ...
    "about": {
      "title": "אודותינו",
      "aboutLabel": "אודות Taiar",
      "aboutDesc": "ב-Taiar, אנו מתמחים במשלוח חבילות באיכות גבוהה ברחבי הגדה המערבית, ירושלים ואזור 48. המשימה שלנו היא לספק פתרונות שילוח מהירים, אמינים ובטוחים המותאמים לצרכים שלך. בין אם מדובר במשלוחים עסקיים או אישיים, אנו מבטיחים שכל חבילה תגיע ליעדה בבטחה ובזמן. עם המחויבות שלנו למצוינות ולשביעות רצון הלקוחות, Taiar היא השותפה המהימנה שלך לחוויית לוגיסטיקה חלקה. חווה משלוח ללא טרחה עם צוות ששם דגש על יעילות וטיפול."
    },
    "locations": {
      "title": "מיקומים",
      "tulkarm": {
    ...
    "action": {
      "options": {
        "moneyRecord": "תיעוד כספי",
        "returnedRecord": "תיעוד החזרות",
        "returnedRecordCollections": "אוסף החזרות",
        "businessRecordTitle": "צור אוסף עסקי",
        "returnedRecordTitle": "צור אוסף החזרות",
        "fromDriverBalance": "ליצור מיתרת הנהג?",
        yesFromDriverBalance: "כן, ליצור מיתרת הנהג",
        noFromDriverBalance: "לא, ליצור מיתרת הנהג",
        "businessMoneyConfirmTitle": "ליצור תיעוד כספי?",
        "businessMoneyConfirmText": "האם אתה בטוח שברצונך ליצור תיעוד כספי?",
        "businessReturnedConfirmTitle": "ליצור תיעוד החזרות?",
        "businessReturnedConfirmText": "האם אתה בטוח שברצונך ליצור תיעוד החזרות?",
        "createWithoutSender": "ללא שולח",
        "assign": "הקצה",
        "assignCompany": "הקצה חברה",
        "selectCompanyToAssign": "בחר חברה להקצאה",
        "removeDriver": "הסר נהג",
        "updateNote": "עדכן הערה",
        "updateNoteForMultiple": "עדכן הערה למספר הזמנות"
      }
    },
    "collectionBranchSection": {
      "rows": {
        "current_branch": "סניף נוכחי"
      }
    },
    "withdrawals": {
      "title": "משיכות",
    ...
    "withdrawalsOptions": {
      "driver_salaries": "משכורות נהגים",
      "fuel": "דלק",
      "utilities_purchase": "רכישת שירותים",
      "advance": "מקדמה",
      "maintenance": "תחזוקה",
      "bills": "חשבונות",
      "oversize": "חריגות",
      "collection_payment": "תשלום גבייה",
      "other": "אחר"
    },
    "receivedAmounts": {
      "title": "סכומים שהתקבלו",
      "rows": {
        "received": "התקבל",
        "original_currency": "מטבע מקורי",
    ...
    "financialPreview": {
      "title": "תצוגה מקדימה פיננסית",
      "loading": "טוען מידע פיננסי...",
      "error": "אירעה שגיאה",
      "totalCodValue": "סך ערך החבילות",
      "totalExpenses": "סך הניכויים",
      "finalAmount": "סך הכסף המגיע לנהג",
      "totalSummary": "סך הכסף המגיע לנהג",
      "driverInfo": "מידע על הנהג",
      "totalOrders": "סך כל ההזמנות",
      "driverOutsourceFee": "דמי משלוח עבור הנהג",
      "noFinancialData": "אין מידע פיננסי",
      "driverInfoValue": "נהג: {driver_name}"
    },
    "homeHints": {
      "trackOrder": {
