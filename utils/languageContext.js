...
export const translations = {
  ...
  he: {
    ...
    // Driver and delivery company onboarding
    onboarding: {
      assignOrdersTitle: "הקצה חבילות",
      assignOrdersMessage: "השתמש באפשרות זו כדי לסרוק קודי QR של חבילות ולהקצות אותן לנסיעה שלך. זה עוזר לך לארגן את תהליכי המשלוח בצורה יעילה ולעקוב אחר החבילות במהלך המשלוח.",
      routesTitle: "נהל נסיעות",
      createOrdersTitle: "צור חבילה",
      createOrdersMessage: "צור חבילה חדשה בקלות. הזן את המידע הנדרש וצור את החבילה שלך כעת.",
      routesMessage: "צור ונהל מסלולים של משלוחים כדי לשפר את תהליכי המשלוח העצמיים. תכנן את הנסיעה שלך, ועקב אחר ההתקדמות בזמן שאתה משלם את החבילות, ונע בצורה יעילה בין מיקומי המשלוח.",
      
      // Orders onboarding tutorial
      orders: {
        welcome: {
          title: "ברוכים הבאים למסך החבילות!",
          description: "בואו נבין כיצד לנהל את החבילות שלך בצורה יעילה."
        },
        expand: {
          title: "הרחב וצמצם",
          description: "הקש על כפתור החץ כדי להרחיב או לצמצם את החבילה כדי לראות יותר או פחות פרטים."
        },
        track: {
          title: "עקוב אחר החבילות",
          description: "הקש על כל חבילה כדי לראות מידע העקיפים המפורטים וההיסטוריה."
        },
        status: {
          title: "שינוי סטטוס",
          description: "הקש על חבילה או על סמל הסטטוס כדי לעדכן את סטטוס החבילה."
        },
        edit: {
          title: "עריכת חבילות",
          description: "הקש על חבילה כדי לגשת לאפשרויות עריכת פרטי החבילה."
        },
        phone: {
          title: "עריכת מספר טלפון",
          description: "הקש על חבילה כדי לגשת לאפשרויות עריכת מספרי טלפון של המקבל."
        },
        complaint: {
          title: "פתיחת קשר",
          description: "הקש על חבילה כדי לגשת לאפשרויות פתיחת קשר ולדווח על בעיות בחבילה."
        },
        tapToExpand: "הקש על כדי להרחיב"
      }
    },
    
    // Add driver statistics translations
    driverStats: {
      title: "סטטיסטיקות סוכן משלוח",
      count: "מספר",
      deliveryFee: "מחיר משלוח",
      codValue: "ערך דיבידנד",
      ordersChart: "פירוט חבילות",
    ...
    createOnboarding: {
      welcome: {
        title: "ברוכים הבאים למסך צור חבילה!",
        message: "בואו נבין כיצד לצור חבילה בצורה יעילה."
      },
      orderTypes: {
        title: "בחר סוג חבילה",
        message: "בחר סוג חבילה:\n\n• משלוח: שליחת חבילות ללקוחות.\n• קבלה: קבלת חבילות מלקוח ושליחתן לך. יש לשים לב כי זהה הוא נותן לך סכום בחשבון שלך, או שיש לך לשלם ערך דיבידנד באחד מהפיקודים שלנו לפני ביצוע הפעולה.\n• משלוח / קבלה: שליחת חבילה ללקוח עם קבלת חבילה אחרת ממנו באותו הזמן.\n• תשלום: שליחת סכום מלקוח. זהה הוא נותן לך סכום בחשבון שלך, או שיש לך לשלם ערך דיבידנד באחד מהפיקודים שלנו לפני ביצוע הפעולה. "
      },
      reference: {
        title: "מזהה משלוח",
        message: "כבר מצאנו דרך חדשה לעקוב אחר חבילות שלך בקלות, באמצעות קודי QR שאנו מספקים לך כדי שתוכל לעקוב אחריהן בקלות"
      },
      client: {
        title: "מידע מקבל",
        message: "הזן פרטי התקשרות עם המקבל כולל שם, מספרי טלפון, עיר וכתובת. כאשר מזינים מספר טלפון של המקבל וקיים במערכת שלנו תופיע לך כדי שתוכל לבחור אותו בקלות"
      },
      cost: {
        title: "מחיר משלוח",
        message: "אתה יכול לבחור בסוג התשלום המבוקש, ערך דיבידנד ומחיר משלוח. באפשרותך להוסיף יותר ממטבע אחד אם תרצה לקבל תשלומים במטבעות שונים או בכל המטבעות."
      },
      netValue: {
        title: "חישוב ערך נקי",
        message: "ערך נקי יוצג בצבע ירוק, והוא מייצג את הסכום המושקע לך לאחר חישוב מחיר המשלוח."
      },
      details: {
        title: "פרטי החבילה",
        message: "כתוב פרטי החבילה. שים לב כי זוויות חלקיות ואתה יכול להשאיר אותן ריקות"
      },
      notes: {
        title: "הערות נוספות",
        message: "הוסף כל פרט נוסף שיעזור במשלוח או בטיפול בחבילה."
      },
      ready: {
        title: "מוכן ללך!",
        message: "אתה מוכן! יש ללחוץ על כפתור שליחה כאשר תשלים את כל המידע הנדרש לצורת החבילה."
      },
      back: "הקודם",
      next: "הבא",
      skip: "דלג הדרכה",
    ...
    auth: {
      ...
      area: "איזור",
      address: "כתובת",
      comercialName:"שם חברה",
      registerSuccess:"כבר צורת חשבון שלך בהצלחה, יש לכנוס בכניסה עכשיו",
      registrationFailed:"צורת חשבון נכשלה",
      loginFailed:"כניסה נכשלה",
      phonePlaceholder: "הזן מספר טלפון",
      passwordPlaceholder: "הזן סיסמה",
      biometricLoginFailed: "כניסה באמצעות ביקורת נכשלה",
      noPreviousLogin: "יש לכנוס בכניסה עכשיו",
      biometricPrompt: "כניסה באמצעות ביקורת",
      cancel: "בטל",
      biometricFailed: "אימות נכשל",
      credentialsNotFound: "לא נמצאו נתוני כניסה",
      phoneRequired: "מספר טלפון נדרש",
      passwordRequired: "סיסמה נדרשת",
      welcome: "ברוכים הבאים חזרה",
      signMessage: "כניסה לחשבון",
      loginWithBiometric: "כניסה באמצעות ביקורת",
      or: "או",
      ...
      comercialNamePlaceholder: "הזן שם חברה",
      businessActivity: "סוג הנסיעה",
      businessActivityPlaceholder: "מה תמכור / תספק؟ (אופציונלי)",
      cityPlaceHolder: "בחר עיר",
      areaPlaceholder: "הזן איזור",
      addressPlaceholder: "הזן כתובת",
      secondPhone: "מספר טלפון נוסף",
      secondPhonePlaceholder: "הזן מספר טלפון נוסף (אופציונלי)",
      website: "אתר אינטרנט",
      websitePlaceholder: "הזן קישור אתר (אופציונלי)",
      tiktok: "טיק טוק",
      facebook: "פייסבוק",
      instagram: "אנסטגרם",
      tiktokPlaceholder: "הזן שם משתמש טיק טוק (אופציונלי)",
      facebookPlaceholder: "הזן דף פייסבוק (אופציונלי)",
      instagramPlaceholder: "הזן חשבון אנסטגרם (אופציונלי)",
      personalInfo: "מידע אישי",
      businessDetails: "פרטי הנסיעה",
      socialMedia: "מועדוני תקשורת",
      nameRequired: "שם נדרש",
      passwordValidation: "סיסמה חייבת להכיל לפחות 6 תווים",
      passwordConfirmation: "אנא אשר סיסמה",
      passwordMismatch: "סיסמאות אינן תואמות",
      businessNameRequired: "שם הנסיעה נדרש",
      cityRequired: "עיר נדרשת",
      noFields: "אין שדות זמינים בשלב זה",
      successRegiser: "הרשמה בהצלחה",
      back: "הקודם",
      next: "הבא",
    ...
    errors:{
      error:"שגיאה",
      success:"הצלחה",
      failedToParse:"הפנייה נכשלה. אנא נסה שוב.",
      requestTimedOut:"הזמן הפנייה נגמר. אנא ודא שהחיבור שלך נכון ונסה שוב.",
      requestAborted:"הפנייה בוטלה. אנא נסה שוב.",
      ...
      noItemsScanned:"אין פריטים נסחרים",
    },

    "check": {
    "receiver": {
      "title": "בדיקת מקבל",
      "desc": "הזן מספר טלפון כדי לבדוק אם קיים מקבל",
      "placeholder": "הזן מספר טלפון",
      "results": "תוצאות החיפוש",
      "noResults": "אין מקבלים בעלי מספר טלפון זה",
      "totalOrders": "סה״כ הזמנים",
      "returnedOrders": "מוחזרים",
      "comment": "הערות"
    }
  },

    driverNotification:{
      title:"הודעה לסוכנים על קיום חבילות מוכנות לקבלה",
      cancel:"בטל",
      send:"שליחה",
      sendNotification:"שליחת הודעה",
      sending:"שולח הודעה...",
      sent:"שולח הודעה",
      error:"שליחת הודעה נכשלה",
      selectDrivers:"בחר סוכנים",
      selectDriversMessage:"אנא בחר את הסוכנים שברצונך להודיע.",
      success:"הצלחה",
      errorMessage:"שליחת הודעה נכשלה",
      notificationSent:"שולח הודעה",
    },
    ...
    routes: {
      ...
      completedTabs: "מסלולים מושלמים",
      noActiveRoutes: "אין מסלולים פעילים",
      noCompletedRoutes: "אין מסלולים מושלמים",
      createRoutePrompt: "יצירת מסלול חדש כדי לארגן את תהליכי המשלוח שלך",
      createRoute: "יצירת מסלול חדש",
      create: "יצירת מסלול",
      edit: "עריכה",
      navigate: "ניווט",
      routeName: "שם המסלול",
      enterRouteName: "הזן שם המסלול",
      orders: "הזמנות",
      optimized: "שופר",
      completed: "מושלם",
      addOrders: "הוספת הזמנות",
      optimize: "שיפור",
      listView: "מציג רשימה",
      mapView: "מציג מפה",
      noOrders: "אין הזמנות במסלול זה",
      addOrdersPrompt: "הוספת הזמנות כדי ליצור מסלול משלוח שלך",
      dragInstructions: "הפעיל ישירות וגרור לשינוי הסדר",
      markAsCompleted: "סימון כמושלם",
      saveRoute: "שמירת המסלול",
      removeOrder: "הסרת הזמנה",
      callOptions: "בחירת קישור",
      whatsapp: "וואטסאפ",
      regularCall: "קישור רגיל",
      cancel: "בטל",
      removeOrderConfirm: "האם אתה בטוח שברצונך להסיר את הזמנה זו מהמסלול؟",
      errorLoadingRoute: "שגיאה בטעינת פרטי המסלול",
      cannotModifyCompleted: "אין אפשרות לערוך מסלול מושלם",
      needMoreOrders: "חייב להיות לפחות 2 הזמנות כדי לשפר את המסלול",
      optimizationFailed: "שגיאה בשפירת המסלול",
      routeOptimizedMessage: "מסלולך שופר כדי לקבל סדר משלוח יעיל ביותר.",
      alreadyCompleted: "זהו מסלול מושלם כבר",
      emptyRouteCompletion: "אין אפשרות להשלים מסלול ריק",
      completeRoute: "השלמת המסלול",
      completeRouteConfirm: "האם אתה בטוח שברצונך לסמן זהו מסלול כמושלם؟ אין אפשרות לבטל את הפעולה.",
      completionFailed: "שגיאה בהשלמת המסלול",
      routeCompleted: "מסלול סומן כמושלם בהצלחה",
      errorAddingOrders: "שגיאה בהוספת הזמנות למסלול",
      errorRemovingOrder: "שגיאה בהסרת הזמנה מהמסלול",
      saveFailed: "שגיאה בשמירת המסלול",
      routeSaved: "מסלול נשמר בהצלחה",
      yourLocation: "מיקום הזמנתך",
      ...
      phone: "מספר טלפון",
      call: "קישור",
      changeStatus: "עדכון סטטוס",
      selectStatus: "בחירת סטטוס",
      selectReason: "בחירת סיבה",
      confirmStatusChange: "אישור שינוי סטטוס",
      confirmStatusChangeMessage: "האם אתה בטוח שברצונך לשנות את הסטטוס ל",
      reason: "סיבה",
      statusChangeNotAllowed: "אין אפשרות לשנות את הסטטוס של הזמנה זו",
      errorUpdatingStatus: "שגיאה בעדכון סטטוס",
      deleteRouteTitle: "מחיקת מסלול",
      deleteRouteConfirm: "האם אתה בטוח שברצונך למחוק את המסלול זה؟ אין אפשרות לבטל את הפעולה.",
      routeDeleted: "מסלול נמחק בהצלחה",
      error: "שגיאה",
      accessDeniedMessage: "זו הינה תכונה בלבד לסוכנים וחברות המשלוח.",
    ...
    balance:{
      balanceHistory:"סירוגין המזומנים",
      "paymentType": "מעבר",
      "transactionType": "מעבר",
      "otherType": "שינוי",
      "balanceAfter": "מזומן לאחר המעבר",
      "currentBalance": "מזומן נוכחי",
      "noTransactions": "אין מעברים",
      "loading": "טוען"
    },
    ...
    tabs: {
      index: {
        title: "דף הבית",
        summaryTitle:"סיכום הזמנות",
        statusTitle:"תצוגה כללית",
        boxes: {
          todayOrders: "הזמנות היום",
          moneyInBranches: "מזומן בסניפים",
          readyMoney:"מזומן זמין לקבלה",
          readyOrders:"חבילות מוכנות לקבלה",
          moneyInBranch: "מזומן בסניפים",
          moneyWithDrivers: "מזומן עם סוכנים",
          moneyWithDriver: "מזומן בעלי חבילה",
          inWaiting: "בהמתנה",
          inBranch: "בסניפים",
          onTheWay: "בדרכו",
          delivered: "משלוח",
          returned: "מופץ מחדש בסניפים",
          rescheduled: "מופץ מחדש",
          returnedInBranch: "מופץ מחדש בסניפים",
          replacedDeliveredOrders: "חבילות מוכנות לקבלה",
          stuck: "מוגבל",
          rejected: "מחוק",
          ofOrders: "מספר הזמנות",
          withDriver: "עם סוכן"
        },
        balanceTitle:"מזומן שלך",
        balance:{
          available:"מזומן נוכחי",
        }
      },
      orders: {
        title: "הזמנות",
        ...
        filters: {
          ...
          onTheWay: "בדרכו",
          replacedDeliveredOrders: "חבילות מוכנות לקבלה",
          driverResponsibilityOrders: "עם סוכן",
          rescheduled: "מופץ מחדש",
          returnBeforeDeliveredInitiated: "מופץ מחדש לפני המשלוח",
          returnAfterDeliveredInitiated: "מופץ מחדש לאחר המשלוח",
          returned: "מופץ מחדש",
          returnedInBranch: "מופץ מחדש בסניפים",
          returnedOut: "מופץ מחדש לאחר המשלוח",
          businessReturnedDelivered: "מופץ מחדש לאחר המשלוח לסוכן",
          delivered: "משלוח",
          moneyInBranch: "מזומן בסניפים",
          moneyOut: "מופץ מחדש לאחר המשלוח",
          businessPaid: "משולמ",
          completed: "מושלם",
          received:"מופץ מחדש לאחר המשלוח",
          "delivered/received":"מופץ מחדש לאחר המשלוח / מופץ מחדש לאחר המשלוח",
          dispatched_to_branch:"מופץ לסניפים",
          // searchByGroup
          orderId: "מספר הזמנה",
          referenceID: "מספר הזמנה",
          sender: "שולח",
          receiverName: "שם המקבל",
          receiverPhone: "מספר טלפון המקבל",
        ...
        track: {
          orderTracking: "מעקב אחר הזמנה",
          order: "הזמנה",
          package: "חבילה",
          quantity: "כמות",
          weight: "משקל",
          receivedItems: "פריטים מופצים",
          receivedQuantity: "כמות מופצית",
          deliveryStatus: "סטטוס המשלוח",
          branch: "סניפים",
          issue: "יש לך בעיה? פנה פרטים",
          openCase: "פתח פרטים",
          unknown: "לא ידוע",
          "loading": "טוען...",
          "errorTitle": "אזהרה!",
          "orderNotFound": "הזמנה לא נמצאה או לא ניתן לטעון",
          "goBack": "חזרה",
          "tryAgain": "נסה שוב",
          "receiverInfo": "מידע המקבל",
          "name": "שם",
          "mobile": "טלפון נייד",
          "secondMobile": "טלפון נייד נוסף",
          "location": "מיקום",
          "address": "כתובת",
          "senderInfo": "מידע השולח",
          ...
          "itemType": "סוג החבילה",
          "driver": "סוכן",
          "financialDetails": "פרטים מכלליים",
          "codValue": "ערך הדיבידנד",
          "deliveryFee": "מחיר המשלוח",
          "netValue": "ערך נקי",
          "checks": "ביקורות",
          "checkNumber": "מספר הביקורת",
          "checkValue": "ערך הביקורת",
          "checkDate": "תאריך הביקורת",
          "notes": "הערות",
          "packageDetails": "פרטים של החבילה",
          "package": "חבילה",
          "quantity": "כמות",
          "weight": "משקל",
          "receivedItems": "פריטים מופצים",
          "receivedQuantity": "כמות מופצת",
          "deliveryStatus": "סטטוס המשלוח",
          "needHelp": "יש לך בעיה? פנה פרטים",
          "openCase": "פתח פרטים"
        },
        "order": {
          "states": {
            "on_the_way_back": "מופץ מחדש לפני המשלוח",
            "pickedUp": "מופץ",
            "deliveredToDestinationBranch": "מופץ לסניפים",
            "rejected": "מחוק",
            "cancelled": "מבוטל",
            "stuck": "מוגבל",
            "rescheduled": "מופץ מחדש",
            "on_the_way": "מופץ",
            "dispatched_to_branch": "מופץ לסניפים",
            "return_before_delivered_initiated": "מופץ מחדש לפני המשלוח",
            "return_after_delivered_initiated": "מופץ מחדש לאחר המשלוח",
            "return_after_delivered_fee_received": "מופץ מחדש לאחר המשלוח והתשלום נקלט",
            "delayed": "מאוחר",
            "failedToUpdate": "מופץ מחדש לאחר המשלוח",
            "forOrders": "לפרטי הזמנה",
            "referenceIdUpdated": "מופץ מחדש לאחר המשלוח",
            "referenceIdUpdateError": "מופץ מחדש לאחר המשלוח",
            "suspendReasons": {
              "closed": "מופץ מחדש לאחר המשלוח",
              "no_response": "אין תגובה",
              "cancelled_from_office": "מבוטל מהמשרד",
              "address_changed": "מופץ מחדש לאחר המשלוח",
              "not_compatible": "מופץ מחדש לאחר המשלוח",
              "delivery_fee_issue": "מופץ מחדש לאחר המשלוח",
              "duplicate_reschedule": "מופץ מחדש לאחר המשלוח",
              "receive_issue": "מופץ מחדש לאחר המשלוח",
              "sender_cancelled": "מבוטל מהשולח",
              "reschedule_request": "מופץ מחדש לאחר המשלוח",
              "incorrect_number": "מופץ מחדש לאחר המשלוח",
              "not_existing": "מופץ מחדש לאחר המשלוח",
              "cod_issue": "מופץ מחדש לאחר המשלוח",
              "death_issue": "מופץ מחדש לאחר המשלוח",
              "not_exist_in_address": "מופץ מחדש לאחר המשלוח", 
              "receiver_cancelled": "מבוטל מהמקבל",
              "receiver_no_response": "אין תגובה מהמקבל",
              "order_incomplete": "מופץ מחדש לאחר המשלוח",
              "receive_request_issue": "מופץ מחדש לאחר המשלוח",
              "other": "מופץ מחדש לאחר המשלוח"
            },
            "delivered": "משלוח",
            "waiting": "בהמתנה",
            "inBranch": "בסניפים",
            ...
            "delivered": "משלוח",
            "received": "מופץ מחדש לאחר המשלוח",
            "delivered_received": "משלוח / מופץ מחדש לאחר המשלוח"
          },
          "editPhone": "עריכה",
          "receiverAddress": "כתובת המקבל",
          "codValue": "ערך הדיבידנד",
          "codUpdateReason": "סיבת השינוי של ערך הדיבידנד",
          "enterReason": "הזן סיבה לשינוי",
          "codUpdateNote": "הערה: עליך לאשר את השינוי של ערך הדיבידנד על ידי השולח",
          "loading": "טוען...",
          "codValue": "ערך הדיבידנד",
          "error": "שגיאה",
          "errorFetchingOrder": "שגיאה בטעינת נתוני הזמנה",
          "ok": "אישור",
          "phoneUpdateSuccess": "הטלפון עודכן בהצלחה",
          "receiverDetailsUpdateSuccess": "הפרטים של המקבל עודכנו בהצלחה",
          "codUpdateRequestSuccess": "הבקשה לשינוי ערך הדיבידנד נשלחה בהצלחה, תקבלו עדכון על האישור",
          "receiverPhones": "טלפוני המקבל",
          "loading": "טוען...",
          "error": "שגיאה",
          "errorFetchingOrder": "שגיאה בטעינת נתוני הזמנה",
          "ok": "אישור",
          "missingStatus": "לא נבחרה סטטוס",
          "selectReason": "בחר סיבה",
          "statusChangeSuccess": "הסטטוס עודכן בהצלחה",
          "statusChangeError": "שגיאה בעדכון הסטטוס",
          "selectBranch": "בחר סניפים",
          "reason": "סיבה",
          "branch": "סניפים",
          "orderType": "סוג הזמנה",
          "unknown": "לא ידוע",
          "userSenderBoxLabel": "השולח",
          "userClientBoxLabel": "הלקוח",
          "userDriverBoxLabel": "הסוכן",
          "userBoxPhoneContactLabel": "צ'אט",
          ...
          "confirmStatusChange":"האם אתה בטוח שברצונך לשנות את הסטטוס של הזמנה זו לבעיטה שלך ؟",
          "changeStatus": "שינוי הסטטוס",
          "changeStatusAlert": "אתה עלול לשנות את הסטטוס של הזמנה זו לבעיטה שלך",
          "changeStatusAlertNote": "הזן הערה...",
          "changeStatusAlertConfirm": "אישור",
          "changeStatus": "שינוי הסטטוס",
          "changeStatusAlertCancel": "ביטול",
          "print": "פריסה",
          "location": "מיקום",
          "to_branch":"שלח לסניפים",
          "to_driver":"שלח לסוכן",
          "financialDetails": "פרטים מכלליים",
          "codValue": "ערך הדיבידנד",
          "netValue": "ערך נקי",
          "deliveryFee": "מחיר המשלוח",
          "checksAvailable": "ביקורות זמינות",
          "note": "הערה",
          ...
          "receivedItems": "פריטים מופצים",
          "receivedQuantity": "כמות מופצת",
          "enterReferenceId":"הזן מזהה משלוח",
            "referenceIdHelper":"אתה יכול להזין אותו או לסרוק קוד QR/ברקוד",
            "referenceIdPlaceholder":"הזן מזהה משלוח",
            "scan":"סרוק",
            "skip":"דלג",
            "save":"שמור",
            "referenceIdRequired":"מזהה משלוח נדרש",
          "noteRequiredForOther": "הערה נדרשת בעת בחירת סיבה \"אחר\"",
          "statusChangeOffline": "הסטטוס יעודכן בעת חיבור לאינטרנט",
          "resend":"שלח שוב למקבל אחר",
          "orderChecks": {
            "addCheck": "הוסף ביקורת",
            "title": "ביקורות הזמנה",
            "orderId": "מזהה הזמנה",
            "loading": "טוען...",
            ...
            "check": "شيك",
            "value": "القيمة",
            "checkNumberPlaceholder": "הזן מזהה ביקורת",
            "number": "מזהה",
            "currency": "מטבע",
            "date": "תאריך",
            "noChecks": "אין ביקורות",
            "noChecksMessage": "אין ביקורות מקושרות לזה הזמנה.",
            "backToOrder": "חזרה",
            "checkDetails": "פרטי הביקורת",
          }
        },
        validation: {
          required: "אנא ודא שכל השדות מולאו"
        },
        save: "שמור השינויים",
        cancel: "ביטול",
        error: "שגיאה",
        success: "הצלחה",
        errorMsg: "שגיאה נכשלה",
        errorValidationMsg: "אנא תיקן את השגיאות בטפס",
        // (create)
        create: {
          edit: "עריכה",
          create: "יצירת זמנה",
          ...
          loading: "טוען...",
          success:"הצלחה",
          successMsg:"הזמנה נרשמה בהצלחה",
          error: "שגיאה",
          errorValidationMsg: "אנא ודא שכל השדות מולאו",
          errorMsg: "שגיאה נכשלה, אנא צור את סוכן התמיכה לעזור",
          insufficientBalance:"רכישה שגויה",
          insufficientBalanceMsg:"רכישה שגויה",
          "save": "שמור השינויים",
          "cancel": "ביטול",
          "phoneUpdateSuccess": "הטלפון עודכן בהצלחה",
          "receiverDetailsUpdateSuccess": "הפרטים של המקבל עודכנו בהצלחה",
          sections: {
            referenceId:{
              title:"מזהה משלוח (אופציונלי)",
              explain:"הזן קוד QR שלך אם זמין"
            },
            sender: {
              title: "השולח",
              fields: {
                "sender": "השולח",
                "with_money_receive": "עם מטבע מסור",
                "my_balance_deduct": "חיסכון מהרכישה",
                "sender_deduct": "חיסכון מהשולח",
                "processing_return": "מעבד חיסכון",
                "please_wait": "אנא המתן...",
                "return_success": "חיסכון נכשל",
                "balance_returned": "הרכישה נחזרה בהצלחה",
                "return_error": "שגיאה בחיסכון",
                "return_failed": "חיסכון נכשל",
                "deduction_error": "שגיאה בחיסכון",
                "deduction_failed": "חיסכון נכשל",
                "updating_deductions": "מעדכן חיסכון",
                "update_deduction_failed": "חיסכון נכשל",
                "deduction_success": "חיסכון נכשל",
                "deduction_processed": "חיסכון נכשל",
                "processing_deduction": "מעבד חיסכון",
                "select_deduction_method": "בחר שיטת חיסכון",
                "choose_deduction_method": "בחר כיצד תרצה לחסכן הרכישה",
                "manual_deduction": "חיסכון ידני",
                "auto_deduction": "חיסכון טכנולוגי",
                "checking_balance": "בודק רכישה",
                "select_deduction_currency": "בחר מטבע חיסכון",
                "choose_currency": "בחר מטבע",
                "available": "מולא",
                "needed": "נדרש",
                "deduct_amount": "סכום לחסכן",
                "current_balance": "רכישה נכשל",
                "new_balance": "רכישה נכשל",
                "deduction_ready": "רכישה נכשל",
                "deduction_on_submit": "חיסכון יופעך בעת שליחה",
                "insufficient_balance_for": "רכישה שגויה",
                "confirm_auto_deductions": "חיסכון טכנולוגי",
                "system_will_deduct": "המערכת תחסכן",
                "from_available_balances": "מהרכישות המולאות",
                "deductions_ready": "חיסכון נכשל",
                "deductions_on_submit": "חיסכון יופעך בעת שליחה",
                "sender_required": "רכישה שגויה",
                "cod_required": "רכישה שגויה",
                "no_cod_values": "רכישה שגויה",
                "cancel": "ביטול",
                "confirm": "אישור",
                "confirm_deduction": "אישור חיסכון",
                "confirm_return": "אישור חיסכון",
                "confirm_balance_return": "אישור חיסכון",
                "return_balance_confirmation": "האם אתה בטוח שברצונך לחזור את הסכומים שחוסכת קודם לרכישה?",
                "yes": "כן",
                "no": "لا",
                "ok": "אישור",
                "currency_mismatch": "שגיאה במתאמת מטבע",
                "exceed_balance": "חיסכון שגוי",
                "exceed_balance_desc": "חיסכון שגוי",
                "balance_confirmation": "אישור חיסכון",
                "balance_change_confirmation": "זה פעולה תשפיע על רכישה של השולח. האם אתה בטוח שברצונך להמשיך?",
                "return_balance": "חיסכון",
                "deduction_amounts": "סכומים לחסכן",
                "balance_after": "רכישה של השולח",
                "auto_deduction_notice": "מולא חיסכון",
                "auto_deduction_message": "חיסכון יופעך בעת שליחה",
                "auto_deduction_message_payment": "חיסכון יופעך בעת שליחה"
              }
            },
            client: {
              title: "מקבל",
              fields: {
                found:"מולא באופן אוטומטי",
                name:"שם",
                client: "מקבל",
                firstPhone: "טלפון",
                secondPhone: "טלפון שני",
                city: "עיר",
                area: "איזור",
                address: "כתובת",
                searchReceiver:"חפש מקבל",
                enterPhone:"הזן מספר טלפון",
                noReceivers:"אין מקבלים",
                found:"מולא",
                receivers:"מקבלים",
                search_error:"יש להזין מספר טלפון תקין",
                no_results:"אין מקבלים",
                enter_more:"הזן 3 מספרים לפחות לחיפוש",
                add_new:"הוסף מקבל חדש",
                enter_valid_phone:"הזן מספר טלפון תקין",
                add_new_receiver:"הוסף מקבל חדש",
                unnamed:"לא ידוע",
                search_receiver:"הזן מספר טלפון",
            ...
            cost: {
              ...
              fields: {
                "netValue": "ערך נקי",
                "checks":"ביקורות",
                "packageCost": "מחיר משלוח מולא",
                "totalPackageCost": "מחיר משלוח מולא",
                "amount": "סכום",
                "deliveryFee": "מחיר משלוח",
                "isReplaced": "מוחלף",
                "insufficient_balance": "רכישה שגויה",
                "balance": "רכישה נכשל",
                "insufficient_balance_alert": "רכישה שגויה לצורת המשלוח",
                "missing_fields": "שדות חסרים",
                "fields_required": "יש להזין פרטים של המקבל או מחיר משלוח או ערך דיבידנד"
              }
            },
            details: {
              title: "פרטי החבילה",
            ...
            orderTypes: {
              title: "סוג החבילה",
              titlePlaceholder:"בחר סוג החבילה",
              delivery: "משלוח",
              receive: "מגיע",
              "delivery/receive": "משלוח / מגיע",
              payment: "תשלום",
              receivedItems: "פריטים מקבלים",
              receivedQuantity: "כמות מקבלים"
            },
            currencyList: {
              title: "מטבע",
              ILS: "שקל",
        ...
        "collections": {
          ...
          "options": {
            ...
            "business_returned_collections": "אוספי החזרות/קבלות לעסקים",
            "runsheet_collections": "אוספי משלוחים בתהליך",
            "sent_collections": "גביית כספים שנשלחו עם נהגים",
            "my_money_collections": "הגבייה הכספית שלי",
            "my_returned_collections": "אוספי החזרות/קבלות שלי",
            "driver_own_collections": "גביית כספים שלי שנאספו מעסקים",
            "driver_own_sent_collections": "גביית כספים שנשלחו לעסקים"
          }
        },
        "settings": {
          "title": "הגדרות",
          "options": {
            ...
            "removeAccount": "מחיקת חשבון",
            "removeAccountMessage": "האם אתה בטוח שברצונך למחוק את החשבון? ניתן להוסיף אותו שוב מאוחר יותר.",
            "cancel": "ביטול",
            "remove": "מחיקה",
            "driverStats": "סטטיסטיקות נהג"
          }
        ...
        "collections": {
          ...
          "collection": {
            ...
            "finalAmount": "הסכום הסופי",
            "request_money": "בקש את הכסף שלך",
            "prepare_money": "הכן את הכסף שלי",
            "send_money": "שלח את הכסף אליי",
            "request_package": "בקש את החבילות שלך",
            "prepare_package": "הכן את החבילות שלי",
            "send_package": "שלח את החבילות אליי",
            "confirmPaymentMessage": "על ידי השלמת פעולה זו, אתה מאשר שקיבלת את הסכום, והחברה אינה אחראית עוד לתלונות עתידיות",
            "cancel": "ביטול",
            "confirm": "אישור",
            "confirmReturnedMessage": "בביצוע פעולה זו, אתה מאשר שקיבלת את החבילה, והחברה אינה נושאת עוד באחריות לתלונות עתידיות בנוגע לקבלה.",
            ...
            "confirmDelivery": "אישור מסירה",
            "partialSuccess": "הצלחה חלקית",
            "updatedCollections": "האוספים עודכנו",
            "success": "הצלחה",
            ...
            "sentMoney": "גביית כספים שנשלחו לעסקים",
            "sentPackages": "אוספי החזרות/החלפות שנשלחו לעסקים"
          }
        },
        "users": {
          "title": "משתמשים",
        ...
        "complaints": {
          ...
          "submit_complaint": "הגשת תלונה",
          "openComplaint": "פתיחת תלונה לבקשה",
          "subject": "נושא",
          "description": "תיאור",
          ...
          "noComplaintsDesc": "אין תלונות שתואמות את המסנן",
        ...
        "notifications": {
          ...
          "confirmation": {
            ...
            "title": "נדרש אישור",
            "message": "האם ברצונך לאשר את הבקשה הזו?",
            "confirm": "אישור",
            "cancel": "ביטול",
            "cod_update": {
              "title": "אישור שינוי ערך החבילה",
              "message": "האם ברצונך לאשר את שינוי ערך החבילה?",
              "approve": "אישור",
              "reject": "דחייה",
            ...
            "money_in": {
              ...
              "message": "האם ברצונך לאשר את עסקת התשלום?",
              "confirm": "אישור",
              "cancel": "ביטול",
            ...
            "money_out": {
              ...
              "message": "האם ברצונך לאשר את עסקת המשיכה?",
              "confirm": "אישור",
              "cancel": "ביטול",
              "successMessage": "העסקה אושרה בהצלחה",
              "amount": "סכום",
        ...
        "camera": {
          "permission": {
            "notGranted": "לא ניתנה הרשאה למצלמה",
          ...
          "scanAgainTapText": "הקש לסריקה מחדש",
          "note": "השאר הערה...",
          "fromBranch": "מסניף",
          "toBranch": "לסניף",
          "confirm": "אישור",
          ...
          "enterOrderId": "הזן מספר סידורי של החבילה",
          "add": "הוסף",
          "toDriver": "לנהג",
        ...
        "contact": {
          ...
          "openingHours": "שעות פתיחה: 9:00 בבוקר - 22:00 בערב",
          "closingHours": "נחזור מחר ב-9:00 בבוקר",
          "connectWithUs": "צור קשר איתנו"
        },
        "about": {
          "title": "אודותינו",
          "aboutLabel": "אודות JSK",
          "aboutDesc": "ב-JSK, אנו מתמחים במשלוח חבילות באיכות גבוהה ברחבי הגדה המערבית, ירושלים ואזור 48. המשימה שלנו היא לספק פתרונות משלוח מהירים, אמינים ובטוחים המותאמים לצרכיך. בין אם מדובר במשלוחים עסקיים או אישיים, אנו מבטיחים שכל חבילה תגיע ליעדה בבטחה ובזמן. עם מחויבותנו למצוינות ושביעות רצון הלקוחות, JSK היא השותפה המהימנה שלך לחוויית לוגיסטיקה חלקה. נסה משלוח ללא טרחה עם צוות שמעניק עדיפות ליעילות ולטיפול."
        },
        "locations": {
          "title": "מיקומים",
          "tulkarm": {
          ...
          "hebron": {
            "title": "חברון",
            "desc": "מרכז המשלוחים בחברון"
          },
          "ramallah": {
            "title": "רמאללה",
            "desc": "מרכז המשלוחים ברמאללה"
          },
          "jenin": {
            "title": "ג'נין",
            "desc": "מרכז המשלוחים בג'נין"
          }
        },
        "greeting": {
          "morning": "בוקר טוב! ☀️",
        ...
        "routesMessage": "צור ונהל מסלולי משלוחים כדי לייעל את פעולות המשלוח. תכנן את המסלול שלך ועקוב אחר ההתקדמות ככל שתשלים הזמנות.",
        "homeHints": {
          "trackOrder": {
            ...
            "driverMessage": "חפש במהירות כל הזמנה על ידי סריקה או הזנת מספר המזהה כדי לבדוק את פרטי המשלוח.",
            "deliveryCompanyMessage": "עקוב במהירות אחר כל הזמנה במערכת שלך על ידי הזנת מספר המזהה לקבלת מידע על הסטטוס בזמן אמת."
          },
          "checkReceiver": {
            "title": "בדיקת מקבל",
            "businessMessage": "בדוק את פרטי המקבל וצפה בהיסטוריית ההזמנות שלו לפני שליחת החבילה אליו.",
            "driverMessage": "בדוק את פרטי המקבל ואת היסטוריית המשלוחים הקודמים לפני ניסיון המשלוח.",
            "deliveryCompanyMessage": "בדוק את פרטי המקבל וצפה בהיסטוריית ההזמנות שלו כדי לנהל את פעולות המשלוח בצורה טובה יותר."
          },
          "orderSummary": {
            "title": "סיכום חבילות",
            "businessMessage": "קבל מבט מהיר על כל החבילות שלך. לחץ על כל כרטיס כדי לראות מידע מפורט על החבילות בסטטוס זה. לחץ לחיצה ארוכה כדי לבקש גביית כספים או חבילות שהתקבלו/הוחזרו.",
            "driverMessage": "צפה בסיכום של ההזמנות שהוקצו לך. לחץ על כל כרטיס כדי לראות את ההזמנות בסטטוס מסוים.",
            "deliveryCompanyMessage": "קבל מבט כולל על כל ההזמנות במערכת שלך. עקוב אחר הביצועים על פני קטגוריות סטטוס שונות."
          },
          "balance": {
            "title": "יתרה כספית",
            "businessMessage": "עקוב אחר היתרה הזמינה שלך במטבעות שונים. לחץ כדי לראות את ההיסטוריה הכספית שלך.",
            "driverMessage": "בדוק את היתרה הנוכחית שלך מגביית כספים. לחץ כדי לראות את ההיסטוריה הכספית שלך."
          },
          "collections": {
            "title": "אישור קבלה",
            "businessMessage": "מכאן תוכל לאשר שקיבלת את הסכומים הכספיים או החבילות שהתקבלו/הוחזרו שנמסרו לך על ידי הנהג או עובד הסניף, כדי להבטיח תיעוד של התהליך ועדכון סטטוס ההזמנה במערכת.",
            "driverMessage": "נהל גביית כספים וחבילות מלקוחות ועסקים.",
            "deliveryCompanyMessage": "נהל גביית כספים וחבילות מוחזרות דרך רשת המשלוחים שלך."
          },
          "statusOverview": {
            "title": "סקירת סטטוס",
            "businessMessage": "חלק זה מציג ייצוג ויזואלי של סטטוסי ההזמנות שלך, כאשר האחוזים מראים את מספר ההזמנות בכל סטטוס בצורה מדויקת וקלה להבנה.",
            "driverMessage": "חלק זה מציג ייצוג ויזואלי של סטטוסי ההזמנות שלך, כאשר האחוזים מראים את מספר ההזמנות בכל סטטוס בצורה מדויקת וקלה להבנה.",
            "deliveryCompanyMessage": "חלק זה מציג ייצוג ויזואלי של סטטוסי ההזמנות שלך, כאשר האחוזים מראים את מספר ההזמנות בכל סטטוס בצורה מדויקת וקלה להבנה."
          },
          "skip": "דלג על הכל",
          "next": "הבא",
          "finish": "הבנתי"
