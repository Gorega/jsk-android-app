...
import { StyleSheet, Modal, Keyboard, Pressable, Animated, TouchableWithoutFeedback, Platform, KeyboardAvoidingView, View } from "react-native";
    ...
    >
      <RTLWrapper>
        <Animated.View
          style={[
            styles.container,
            { backgroundColor: `rgba(0,0,0,${backdropOpacity})`, opacity: fadeAnim, justifyContent: 'flex-start' }
          ]}
        >
          <Pressable
          ...
          >
            <View style={[styles.container, getPositionStyle(), { backgroundColor: 'transparent', width: '100%' }]} pointerEvents="box-none">
